...
MRB_API struct mrb_insn_data mrb_insn_fetch(mrb_state*, const mrb_code*);
            ...
            const mrb_code* pc, mrb_value* /*regs*/)
{
    ...
    struct mrb_insn_data d = mrb_decode_insn(pc);

    fprintf(stderr, "[trace] %s:%d\top=%-3d a=%-3d b=%-3d c=%d\n",
            file ? file : "?", line, d.insn, d.a, d.b, d.c);
}
